import { element, getjQuery, typeCheckConfig, onDOMContentLoaded } from './util/md-index.js'
import MdData from './md/md-data.js'
import MdEventHandler from './md/md-event-handler.js'
import MdManipulator from './md/md-manipulator.js'
import MdSelectorEngine from './md/md-selector-engine.js'
      ...
      if (ripple) {
        ...
        if (this._element) {
          ...
          if (this._isMinWidthSet) {
            MdManipulator.style(this._element, { 'min-width': '' })
            this._isMinWidthSet = false
          }
