/*!
  * Bootstrap ripple.js v5.3.0-alpha1 (https://getbootstrap.com/)
...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Ripple = factory(global.mdIndex, global.Data, global.EventHandler, global.Manipulator, global.MdSelectorEngine));
})(this, (function (mdIndex, Data, EventHandler, Manipulator, MdSelectorEngine) { 'use strict';
  ...
  class Ripple {
    ...
    _removeHTMLRipple({
      ...
      this._rippleTimer = setTimeout(() => {
        if (ripple) {
          ripple.remove();
          if (this._element) {
            MdSelectorEngine.find(`.${CLASSNAME_RIPPLE_WAVE}`, this._element).forEach(rippleEl => {
              rippleEl.remove();
            });
    ...
    _addColor(target, parent) {
      ...
      if (IS_BOOTSTRAP_COLOR) {
        Manipulator.addClass(parent, `${CLASSNAME_RIPPLE}-${this._options.rippleColor.toLowerCase()}`);
      } else {
