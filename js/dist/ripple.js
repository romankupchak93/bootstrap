...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('./util/md-index.js'), require('./md/md-data.js'), require('./md/md-event-handler.js'), require('./md/md-manipulator.js'), require('./md/md-selector-engine.js')) :
  typeof define === 'function' && define.amd ? define(['./util/md-index', './md/md-data', './md/md-event-handler', './md/md-manipulator', './md/md-selector-engine'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Ripple = factory(global.MdIndex, global.MdData, global.MdEventHandler, global.MdManipulator, global.MdSelectorEngine));
})(this, (function (mdIndex_js, MdData, MdEventHandler, MdManipulator, MdSelectorEngine) { 'use strict';
  ...
  class Ripple {
    ...
    _createRipple(event) {
      ...
      const rippleHTML = mdIndex_js.element('div');
    ...
    _getConfig(config = {}) {
      ...
      mdIndex_js.typeCheckConfig(NAME, config, DefaultType);
      return config;
    }
    _getDiameter({
      offsetX,
  ...
  mdIndex_js.onDOMContentLoaded(() => {
    const $ = mdIndex_js.getjQuery();
    if ($) {
