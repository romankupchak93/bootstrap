/*!
  * Bootstrap select-field.js v5.3.0-alpha2 (https://getbootstrap.com/)
  * Copyright 2011-2023 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('./util/color.js'), require('./base-component.js'), require('./dom/event-handler.js'), require('./dropdown.js'), require('./util/index.js')) :
  typeof define === 'function' && define.amd ? define(['./util/color', './base-component', './dom/event-handler', './dropdown', './util/index'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SelectField = factory(global.Color, global.BaseComponent, global.EventHandler, global.Dropdown, global.Index));
})(this, (function (color_js, BaseComponent, EventHandler, Dropdown, index_js) { 'use strict';
  ...
  index_js.defineJQueryPlugin(SelectField);
