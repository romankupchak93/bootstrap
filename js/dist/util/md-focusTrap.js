/*!
  * Bootstrap md-focusTrap.js v5.3.0-alpha1 (https://getbootstrap.com/)
...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.MdFocusTrap = factory(global.MdSelectorEngine, global.index));
  ...
  class FocusTrap {
    ...
    _filterVisible(elements) {
      return elements.filter(el => {
        if (!index.isVisible(el)) return false;
