...
{{< example >}}
<div class="floating-labels mb-3">
  <input type="email" class="form-control" id="floatingInput22222" placeholder="name@example.com">
  <label for="floatingInput22222">Email address</label>
</div>
<div class="floating-labels mb-3">
  <input type="password" class="form-control" id="floatingInput11111" placeholder="name@example.com">
  <label for="floatingInput11111">Password</label>
</div>
{{< /example >}}
...
{{< example >}}
<div class="floating-matter mb-3">
