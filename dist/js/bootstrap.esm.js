...
class ScrollSpy extends BaseComponent {
  ...
  _activateParents(target) {
    ...
    if (target.classList.contains(CLASS_NAME_DROPDOWN_ITEM)) {
      SelectorEngine.findOne(SELECTOR_DROPDOWN_TOGGLE$2, target.closest(SELECTOR_DROPDOWN)).classList.add(CLASS_NAME_ACTIVE$1);
      return;
    }
...
const SELECTOR_COMPONENTS = `${SELECTOR_COMPONENT}, ${SELECTOR_COMPONENT_UNBOUNDED}, ${SELECTOR_DROPDOWN_TOGGLE$1}`;
const Default$1 = {
  setActive: false,
  setUnbounded: false
};
...
export { Alert, Button, Carousel, Collapse, Dropdown, Modal, Offcanvas, Popover, Ripple, ScrollSpy, Tab, Toast, Tooltip };
